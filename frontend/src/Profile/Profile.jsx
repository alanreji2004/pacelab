...
export default function Profile() {
        ...
        <div className={styles.outer}>
            ...
            <div className={styles.teamBox}>
                ...
                <div className={styles.teamControls}>
                    ...
                    <button className={styles.ghost} onClick={() => setShowLeaveModal(true)}>Leave Team</button>
                    )}
                </div>
                </div>
    ...
    <div className={styles.modalWrap}>
        <div className={styles.modal}>
        <h3 className={styles.modalTitle}>Leave Team</h3>
        <p className={styles.lead}>Are you sure you want to leave the team?</p>
        <div className={styles.modalActions}>
            <button className={styles.ghost} onClick={() => setShowLeaveModal(false)}>Cancel</button>
            <button
